...
- [ ] v1.1 — `external_law_citations` 필드: KOICA 규정 안의 외부 법령 인용을 자동 추출해 korean-law-mcp 연계 강화
- [ ] v1.2 — PDF→md 자동 변환 스크립트
- [ ] v1.3 — 음절 bi-gram 매칭 (형태소 변종 대응)
- [ ] v1.4 — 별표·별지 분리 인덱싱 (행정처분 기준표, 서식 등)
